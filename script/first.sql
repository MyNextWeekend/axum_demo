...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='接口域名表';
...
-- `first`.endpoint1 definition

CREATE TABLE `endpoint1` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '名称',
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接口唯一code',
  `method` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'HTTP 请求方法:get,post',
  `domain_code` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '域名code',
  `path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接口路径',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '接口描述',
  `is_active` tinyint(1) DEFAULT '1' COMMENT '是否启用',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `username` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账号',
